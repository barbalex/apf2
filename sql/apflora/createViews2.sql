...
FROM
  ...
  INNER JOIN
    apflora.pop
    ON apflora.v_pop_letzterpopber."ApArtId" = apflora.pop.ap_id)
  INNER JOIN
    apflora.popber
    ON
  ...
  INNER JOIN
    ...
    INNER JOIN
      ...
      INNER JOIN
        ...
        ON apflora.pop.ap_id = apflora.v_tpop_letztertpopber."ApArtId")
      ON
...
FROM
  ...
  INNER JOIN
    apflora.pop
    ON apflora.v_pop_letztermassnber."ApArtId" = apflora.pop.ap_id)
  INNER JOIN
    apflora.popmassnber
    ON

DROP FUNCTION IF EXISTS apflora.q_pop_ohne_popber(apid uuid, berichtjahr integer);
CREATE OR REPLACE FUNCTION apflora.q_pop_ohne_popber(apid uuid, berichtjahr integer)
  ...
  $$
  LANGUAGE sql STABLE;
ALTER FUNCTION apflora.q_pop_ohne_popber(apid uuid, berichtjahr integer)
  OWNER TO postgres;

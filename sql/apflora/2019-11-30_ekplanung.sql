...
with letzte_kontrolle as (
  ...
  select
    tpop.id as tpop_id,
    -- TODO: startjahr depends on letze_kontrolle OR letzte_ansiedlung
    lk.jahr as ekfrequenz_startjahr,
...
update apflora.tpop
set ekfrequenz = apflora.v_tpop_ekfrequenz_to_set.ekfrequenz

...
CREATE TABLE apflora.infoflora20220302original (
  GUID text,
...
CREATE INDEX ON apflora.infoflora20220302original USING btree (no_isfs);

CREATE INDEX ON apflora.infoflora20220302original USING btree (obs_id);

-- 2. import into apflora.infoflora20220302original
-- directly with pgAdmin?
--
-- 3. build temp beob table
CREATE TABLE apflora.infoflora20220302beob (
...
INSERT INTO apflora.infoflora20220302beob (id_field, datum, autor, data, art_id, art_id_original, changed_by, geom_point, quelle)
SELECT
  'obs_id',
  ...
  'Info Flora 2022.01'
FROM
  apflora.infoflora20220302original ROW;

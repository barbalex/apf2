  ...
  <div className={styles.outerContainer}>
    ...
    <div className={styles.scrollContainer}>
      ...
      <div className={styles.cardContainer}>
        ...
        <MaterialCard className={styles.card}>
          <h3 className={styles.cardTitle}>Artverantwortliche</h3>
          Für jede Aktionsplanart ist ein Experte oder eine Expertin
          verantwortlich.
        </MaterialCard>
        <MaterialCard className={styles.card}>
          <h3 className={styles.cardTitle}>Populationen</h3>
        ...
        <MaterialCard className={styles.card}>
          <h3 className={styles.cardTitle}>Idealbiotope</h3>
        ...
        <MaterialCard className={styles.card}>
          <h3 className={styles.cardTitle}>Planung</h3>
        ...
        <MaterialCard className={styles.card}>
          <h3 className={styles.cardTitle}>Beobachtungen</h3>
        ...
        <MaterialCard className={styles.card}>
          <h3 className={styles.cardTitle}>Freiwillige</h3>
        ...
        <MaterialCard className={styles.card}>
          <h3 className={styles.cardTitle}>Organisation des Projektes</h3>
          durch&nbsp;
          <a
            href="//toposmm.ch"
            target="_blank"

...
export const query = gql`
  query QkQuery(
    ...
    tpopAbperNichtRelevantOhneGrund: projektById(id: $projId)
      @include(if: $tpopAbperNichtRelevantOhneGrund) {
      id
      apsByProjId(filter: { id: { equalTo: $apId } }) {
        nodes {
          id
    ...
    tpopMitAktuellenAnpflanzungenOhneZielrelevanteEinheit: qTpopMitAktuellenAnpflanzungenOhneZielrelevanteEinheit(
      berichtjahr: $berichtjahr
      projId: $projId
      apId: $apId
    ...
    anpflanzungZielrelevanteEinheitFalsch: allVQAnpflanzungZielrelevanteEinheitFalsches(
      filter: {
        projId: { equalTo: $projId }
        apId: { equalTo: $apId }
        jahr: { equalTo: $berichtjahr }
      }
    ) @include(if: $anpflanzungZielrelevanteEinheitFalsch) {
      nodes {
        projId
        apId
        popId

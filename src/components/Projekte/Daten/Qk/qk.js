...
export default ({
  ...
  return [
    ...
    },
    {
      ...
      messages: sortBy(get(data, 'popStatus300TpopStatusAnders.nodes', []), [
        'nr',
        'id',
      ]).map(n => ({
        url: [
    ...
    },
    {
      ...
      messages: sortBy(get(data, 'popStatus202TpopStatusAnders.nodes', []), [
        'nr',
        'id',
      ]).map(n => ({
        url: [
    ...
    },
    {
      ...
      messages: sortBy(get(data, 'popStatus101TpopStatusAnders.nodes', []), [
        'nr',
        'id',
      ]).map(n => ({
        url: [
    ...
    // Stati kontrollieren
    {
      ...
      messages: sortBy(get(data, 'popOhnePopmassnber.nodes', []), [
        'nr',
        'id',
      ]).map(n => ({
        url: [
    ...
    // TODO: seems only to output pops with koord but no tpop
    {
      ...
      messages: sortBy(get(data, 'popKoordEntsprechenKeinerTpop.nodes', []), [
        'nr',
        'id',
      ]).map(n => ({
        url: [
    ...
    // Pop-Bericht/Pop-Massn.-Bericht ohne Jahr/Entwicklung
    {
      ...
      messages: (function() {
        ...
        popberNodes = sortBy(popberNodes, n => [get(n, 'popByPopId.nr'), n.id])
    ...
    },
    {
      ...
      messages: (function() {
        ...
        popberNodes = sortBy(popberNodes, n => [
          get(n, 'popByPopId.nr'),
          n.jahr,
        ])
        return popberNodes.map(n => ({
    ...
    // tpop ohne gewollte Werte
    {
      ...
      messages: (function() {
        ...
        tpopNodes = sortBy(tpopNodes, n => [get(n, 'popByPopId.nr'), n.id])
    ...
    },
    {
      ...
      messages: sortBy(get(data, 'tpopPopnrTponrMehrdeutig.nodes', []), [
        'popNr',
        'nr',
      ]).map(n => ({
        url: [
    ...
    },
    {
      ...
      messages: sortBy(get(data, 'tpopOhneTpopber.nodes', []), [
        'popNr',
        'nr',
      ]).map(n => ({
        url: [
    ...
    },
    {
      ...
      messages: sortBy(get(data, 'tpopOhneMassnber.nodes', []), [
        'popNr',
        'nr',
      ]).map(n => ({
        url: [
    ...
    // TPop-Bericht ohne Jahr/Entwicklung
    {
      ...
      messages: (function() {
        ...
        tpopberNodes = sortBy(tpopberNodes, n => [
    ...
    // Massn ohne gewollte Felder
    {
      ...
      messages: (function() {
        ...
        tpopmassnNodes = sortBy(tpopmassnNodes, n => [
          get(n, 'tpopByTpopId.popByPopId.nr'),
          get(n, 'tpopByTpopId.nr'),
          n.id,
        ])
    ...
    // Massn.-Bericht ohne gewollte Felder
    {
      ...
      messages: (function() {
        ...
        tpopmassnberNodes = sortBy(tpopmassnberNodes, n => [
          get(n, 'tpopByTpopId.popByPopId.nr'),
          get(n, 'tpopByTpopId.nr'),
          n.id,
        ])
    ...
    // Kontrolle ohne Jahr/Zählung/Kontrolltyp
    {
      ...
      messages: (function() {
        ...
        tpopkontrNodes = sortBy(tpopkontrNodes, n => [
          get(n, 'tpopByTpopId.popByPopId.nr'),
          get(n, 'tpopByTpopId.nr'),
          n.id,
        ])

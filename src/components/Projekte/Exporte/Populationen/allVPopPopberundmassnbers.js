...
export default gql`
  query viewPopPopberundmassnbers {
    allVPopPopberundmassnbers {
      nodes {
        ...
        jahr
        popber_id: popberId
        popber_jahr: popberJahr
        popber_entwicklung: popberEntwicklung
        popber_bemerkungen: popberBemerkungen
        popber_changed: popberChanged
        popber_changed_by: popberChangedBy

...
export const LetzteZaehlung = () => {
  ...
  const onClickLetzteZaehlung = async () => {
    setQueryState('lade Daten...')
    let result: { data?: PopLastCountsQueryResult | undefined } | undefined
    try {
      result = await apolloClient.query<PopLastCountsQueryResult>({
        query: graphql(`
  ...
  return (
    <Button
      ...
      color="inherit"
      disabled={!!queryState}
      onClick={() => void onClickLetzteZaehlung()}
    >
      Letzte Zählungen
      {queryState ?

...
export const AnzMassnBerichtsjahr = () => {
  ...
  const onClickAnzMassnBerichtsjahr = async () => {
    setQueryState('lade Daten...')
    let result: { data?: PopmassnberAnzMassnsQueryResult | undefined } | undefined
    try {
      result = await apolloClient.query<PopmassnberAnzMassnsQueryResult>({
        query: graphql(`
  ...
  return (
    <Button
      ...
      color="inherit"
      disabled={!!queryState}
      onClick={() => void onClickAnzMassnBerichtsjahr()}
    >

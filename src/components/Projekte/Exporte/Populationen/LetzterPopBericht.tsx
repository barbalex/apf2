...
export const LetzterPopBericht = () => {
  ...
  const onClickLetzterPopBericht = async () => {
    setQueryState('lade Daten...')
    let result: { data?: PopMitLetzterPopberQueryResult | undefined } | undefined
    try {
      result = await apolloClient.query<PopMitLetzterPopberQueryResult>({
        query: graphql(`
  ...
  return (
    <Button
      ...
      color="inherit"
      disabled={!!queryState}
      onClick={() => void onClickLetzterPopBericht()}
    >

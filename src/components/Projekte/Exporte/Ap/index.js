          ...
          <StyledCardContent>
            ...
            <DownloadCardButton
              onClick={async () => {
                ...
                try {
                  const { data } = await client.query({
                    query: await import('./allVApOhnepops').then(
                      m => m.default,
                    ),
                  })
                  exportModule({
            ...
            <DownloadCardButton
              onClick={async () => {
                ...
                try {
                  const { data } = await client.query({
                    query: await import('./allVApAnzmassns').then(
                      m => m.default,
                    ),
                  })
                  exportModule({
            ...
            <DownloadCardButton
              onClick={async () => {
                ...
                try {
                  const { data } = await client.query({
                    query: await import('./allVApAnzkontrs').then(
                      m => m.default,
                    ),
                  })
                  exportModule({
            ...
            <DownloadCardButton
              onClick={async () => {
                ...
                try {
                  const { data } = await client.query({
                    query: await import('./allVApApberundmassns').then(
                      m => m.default,
                    ),
                  })
                  exportModule({
            ...
            <DownloadCardButton
              onClick={async () => {
                ...
                try {
                  const { data } = await client.query({
                    query: await import('./allVIdealbiotops').then(
                      m => m.default,
                    ),
                  })
                  exportModule({

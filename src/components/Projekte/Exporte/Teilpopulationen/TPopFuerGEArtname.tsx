...
export const TPopFuerGEArtname = () => {
  ...
  const onClickTPopKmlNamen = async () => {
    setQueryState('lade Daten...')
    let result: { data?: TPopKmlNamenQueryResult | undefined } | undefined
    try {
      result = await apolloClient.query<TPopKmlNamenQueryResult>({
        query: graphql(`
  ...
  return (
    <Button
      ...
      color="inherit"
      disabled={!!queryState}
      onClick={() => void onClickTPopKmlNamen()}
    >

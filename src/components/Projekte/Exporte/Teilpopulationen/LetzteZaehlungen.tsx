...
export const LetzteZaehlungen = () => {
  ...
  const onClickLetzteZaehlungen = async () => {
    setQueryState('lade Daten...')
    let result: { data?: TPopLastCountsQueryResult | undefined } | undefined
    try {
      result = await apolloClient.query<TPopLastCountsQueryResult>({
        query: graphql(`
  ...
  return (
    <Button
      ...
      color="inherit"
      disabled={!!queryState}
      onClick={() => void onClickLetzteZaehlungen()}
    >
      Letzte Zählungen
      {queryState ? (

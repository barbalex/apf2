...
export const TPopInklBerichte = () => {
  ...
  const onClickTPopInklBerichte = async () => {
    setQueryState('lade Daten...')
    let result: { data?: TPopPopberundmassnberQueryResult | undefined } | undefined
    try {
      result = await apolloClient.query<TPopPopberundmassnberQueryResult>({
        query: graphql(`
  ...
  return (
    <Button
      ...
      color="inherit"
      disabled={!!queryState}
      onClick={() => void onClickTPopInklBerichte()}
    >

...
export const Wollmilchsau = () => {
  ...
  const onClickWollmilchsau = async () => {
    setQueryState('lade Daten...')
    let result: { data?: TPopErsteUndLetzteKontrolleQueryResult | undefined } | undefined
    try {
      result = await apolloClient.query<TPopErsteUndLetzteKontrolleQueryResult>({
        query: graphql(`
  ...
  return (
    <Button
      ...
      color="inherit"
      disabled={!!queryState}
      onClick={() => void onClickWollmilchsau()}
    >

...
export const AnzMassnahmen = () => {
  ...
  const onClickAnzMassnProTpop = async () => {
    setQueryState('lade Daten...')
    let result: { data?: TPopAnzMassnsQueryResult | undefined } | undefined
    try {
      result = await apolloClient.query<TPopAnzMassnsQueryResult>({
        query: graphql(`
  ...
  return (
    <Button
      ...
      color="inherit"
      disabled={!!queryState}
      onClick={() => void onClickAnzMassnProTpop()}
    >

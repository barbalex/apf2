...
export const ZhPflegeplanVVJ = () => (
  <WMSTileLayer
    ...
    layers="FnsPflegevvjZH,pfpl-vor-vergangenes,ueberlagerung1-vor-vergangenes,ueberlagerung2-vor-vergangenes,umgeb-vor-vergangenes,pfpl-label-vor-vergangenes"
    opacity={0.5}
    transparent={true}
    version="1.3.0"
    format="image/png"

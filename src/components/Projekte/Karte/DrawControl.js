...
class DrawControl extends Component {
  ...
  componentDidMount() {
    ...
    window.L.drawLocal.draw.toolbar.buttons.polygon = `Polygon(e) zeichnen, um zu filtern`
    ...
    window.L.drawLocal.draw.handlers.polygon.tooltip.start = `Klicken um Polygon zu beginnen`
    window.L.drawLocal.draw.handlers.polygon.tooltip.cont = `Klicken um Polygon weiter zu zeichnen`
    window.L.drawLocal.draw.handlers.polygon.tooltip.end = `ersten Punkt klicken, um Polygon zu beenden`
    window.L.drawLocal.draw.handlers.rectangle.tooltip.start = `Klicken und ziehen, um Rechteck zu zeichnen`
    ...
    window.L.drawLocal.edit.toolbar.actions.cancel.title = `Zeichnung abbrechen und verwerfen`
    ...
    window.L.drawLocal.edit.toolbar.buttons.editDisabled = `Filter-Umriss(e) ändern (aktuell gibt es keine)`
    window.L.drawLocal.edit.toolbar.buttons.remove = `Filter-Umriss(e) löschen`
    window.L.drawLocal.edit.toolbar.buttons.removeDisabled = `Filter-Umriss(e) löschen (aktuell gibt es keine)`
    window.L.drawLocal.edit.handlers.edit.tooltip.text = `dann auf 'speichern' klicken`
    window.L.drawLocal.edit.handlers.edit.tooltip.subtext = `Punkte ziehen, um Filter-Umriss(e) zu verändern`

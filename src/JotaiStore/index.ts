...
export const treeEkfIsFilteredAtom = atom((get) => {
  // TODO: migrate ekfGqlFilter to jotai
...
export const treeTpopmassnberGqlFilterForTreeAtom = atom((get) => {
  const nodeLabelFilter = get(treeNodeLabelFilterAtom)
...
export const treeApberGqlFilterForTreeAtom = atom((get) => {
  const nodeLabelFilter = get(treeNodeLabelFilterAtom)
  const apId = get(treeApIdInActiveNodeArrayAtom)
  const gqlFilter = {}
...
export const treeApartGqlFilterForTreeAtom = atom((get) => {
  const nodeLabelFilter = get(treeNodeLabelFilterAtom)
  const apId = get(treeApIdInActiveNodeArrayAtom)
  const gqlFilter = {}
...
export const treeAssozartGqlFilterForTreeAtom = atom((get) => {
  const nodeLabelFilter = get(treeNodeLabelFilterAtom)
  const gqlFilter = {}
  // 1. hierarchy filter
  const apId = get(treeApIdInActiveNodeArrayAtom)
...
export const treeEkfrequenzGqlFilterForTreeAtom = atom((get) => {
  const nodeLabelFilter = get(treeNodeLabelFilterAtom)
  const gqlFilter = {}
  // 1. hierarchy filter
  const apId = get(treeApIdInActiveNodeArrayAtom)
...
export const treePopberGqlFilterForTreeAtom = atom((get) => {
  const nodeLabelFilter = get(treeNodeLabelFilterAtom)
  const gqlFilter = {}
  // 1. hierarchy filter
  const popId = get(treePopIdInActiveNodeArrayAtom)
  if (popId) {
...
export const treePopmassnberGqlFilterForTreeAtom = atom((get) => {
  const nodeLabelFilter = get(treeNodeLabelFilterAtom)
  const gqlFilter = {}
  // 1. hierarchy filter
  const popId = get(treePopIdInActiveNodeArrayAtom)
